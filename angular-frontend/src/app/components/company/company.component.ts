...
export class CompanyComponent implements OnInit {
  ...
  openEditModal(id: number): void {
    ...
    this.selectedSSValue = this.companies.find(value => value.id === id).c_serviceSection;
  ...
  saveChanges(): void {
    ...
    this.selectedCompanyValue.c_serviceSection = this.ss.find(value => value.id === this.changedSSId)
